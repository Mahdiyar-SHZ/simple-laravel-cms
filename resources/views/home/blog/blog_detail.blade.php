                    ...
                    <div class="lonyo-blog-widgets">
                        ...
                        <div class="lonyo-blog-categorie">
                            <ul>
                                ...
                                <li><a href="{{ route('blog.category.l' , $blog->id) }}">{{ $blog->category_name }}<span>{{ $blog->posts_count }}</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    <div class="lonyo-blog-widgets">
                        ...
                        <a class="lonyo-blog-recent-post-item" href="single-blog.html">
                            <div class="lonyo-blog-recent-post-thumb">
                                <img src="{{ asset($item->blog_image) }}" alt="" style="width: 60px; height: 60px;">
                            </div>
            ...
            <div class="col-lg-6">
                <div class="lonyo-blog-wrap" data-aos="fade-up" data-aos-duration="700">
                    <div class="lonyo-blog-thumb">
                        <img src="{{ asset('frontend/assets/images/blog/b11.png') }}" alt="">
                    </div>
                    <div class="lonyo-blog-meta">
                        <ul>
                            <li>
                                <a href="blog.html"><img src="{{ asset('frontend/assets/images/blog/date.svg') }}" alt="">June 10, 2025</a>
                            </li>
                            <li>
                                <a href="blog.html"><img src="{{ asset('frontend/assets/images/blog/clock.svg') }}" alt="">7 min read</a>
                            </li>
                        </ul>
                    </div>
                    <div class="lonyo-blog-content">
                        ...
                        <p>As finance goes digital, technology and financial services have become inseparable, with fintech leading global investment...</p>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="lonyo-blog-wrap" data-aos="fade-up" data-aos-duration="900">
                    ...
                    <div class="lonyo-blog-meta">
                        <ul>
                            <li>
                                <a href="blog.html"><img src="{{ asset('frontend/assets/images/blog/date.svg') }}" alt="">June 08, 2025</a>
                            </li>
                            <li>
                                <a href="blog.html"><img src="{{ asset('frontend/assets/images/blog/clock.svg') }}" alt="">2 min read</a>
                            </li>
                        </ul>
                    </div>
                    <div class="lonyo-blog-content">
                        ...
                        <p>Small business owners can save time and money by using automation tools as they prepare for tax season...</p>
                    </div>
                    <div class="lonyo-blog-btn">
                        <a href="blog.html" class="lonyo-default-btn blog-btn">continue reading</a>
                    </div>
