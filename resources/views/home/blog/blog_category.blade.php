...
<div class="breadcrumb-wrapper light-bg">
    <div class="container">
        ...
        <div class="breadcrumb-content">
            <h1 class="breadcrumb-title pb-0">{{ $category_name->category_name }}</h1>
            ...
            <div class="col-lg-8">
                ...
                <div class="lonyo-blog-wrap" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <div class="lonyo-blog-content">
                        <h2><a href="single-blog.html">{{ $item->blog_title }}</a></h2>
                        <p>{{ Str::limit(strip_tags(html_entity_decode($item->blog_content)), 100, '...') }}</p>
                    </div>
                    <div class="lonyo-blog-btn">
                        <a href="{{ route('detail.blog.post', $item->blog_slug) }}" class="lonyo-default-btn blog-btn">continue reading</a>
                    </div>
                </div>
