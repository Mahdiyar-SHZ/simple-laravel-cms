@php
$usability = App\Models\Usability::findOrFail(1);
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="lonyo-video-thumb">
                    ...
                    <a class="play-btn " href="{{ Str::startsWith($usability->youtube, ['http://', 'https://']) ? $usability->youtube : 'https://' . $usability->youtube }}" target="_blank">
            ...
            <div class="col-lg-7 d-flex align-items-center">
                <div class="lonyo-default-content lonyo-video-section pl-50" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div class="mt-50" data-aos="fade-up" data-aos-duration="700">
                        <a class="lonyo-default-btn video-btn" href="{{ Str::startsWith($usability->link, ['http://', 'https://']) ? $usability->link : 'https://' . $usability->link }} " target="_blank">Download the app</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div class="lonyo-process-title">
                        <h4 class="connect-title" contenteditable="{{ $isLoggedIn ? 'true' : 'false' }}" data-id="{{ $connect?->id }}" data-column="title">
                            {{ $connect->title }}
                        </h4>
                    </div>
