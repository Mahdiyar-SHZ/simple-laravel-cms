                ...
                <div class="breadcrumb-menu-wrap">
                    <div class="breadcrumb-menu">
                        <ul>
                            ...
                            <li>
                                <img
                                    src="{{ asset('frontend/assets/images/blog/right-arrow.svg') }}"
                                    alt="right-arrow" />
                            </li>
            ...
            <div class="col-lg-7">
                <div class="lonyo-default-content">
                    ...
                    <p class="max-w616">
                        ...
                        support or want to know more about this tool.
                    </p>
                    <div class="mt-50">
            ...
            <div class="col-lg-5">
                <div
                    ...
                    <form action="{{ route('contact.message') }}" method="post">
                        ...
                        <button class="lonyo-default-btn extra-btn d-block" type="submit">
                            Send your message
                        </button>
                    </form>
                </div>
