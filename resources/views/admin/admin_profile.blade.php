                                                ...
                                                <form action="{{ route('profile.store') }}" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <div class="input-group">
                                                                <span class="input-group-text"><i class="mdi mdi-email"></i></span>
                                                                <input type="tel" class="form-control" value="{{ $profileData->phone }}" name="phone" placeholder="Phone number" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <div class="input-group">
                                                                <span class="input-group-text"><i class="mdi mdi-email"></i></span>
                                                                <input type="file" class="form-control" value="{{ $profileData->phone }}" id="image" name="photo">
                                                            </div>
                                                        </div>
                                                    </div>
