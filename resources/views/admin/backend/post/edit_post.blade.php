                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="card border mb-0">
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('update.blog.post' ,$blog->id) }}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-6 col-xl-6">
                                                            <select name="blog_categoty" class="form-select" id="example-select">
                                                                <option>Select Category</option>
                                                                @foreach ($blogcat as $item )
                                                                <option value="{{ $item->id }}" {{ $item->id == $blog->blog_categoty ? 'selected' : '' }}>{{ $item->category_name }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <textarea name="blog_content" id="description" style="display: none;">{!! $blog->blog_content !!}</textarea>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <img src="{{ asset($blog->blog_image ) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" id="showImage" alt="image profile">
                                                        </div>
                                                    </div>
