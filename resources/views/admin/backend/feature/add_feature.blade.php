                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="card border mb-0">
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('store.feature') }}" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" value="" name="icon" placeholder="Position" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
